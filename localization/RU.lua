UNBOXER_STRINGS = {
    ...
    ["SI_UNBOXER_CHAT_CONTENTS"] =           "Сводка распакованных предметов",
    ["SI_UNBOXER_CHAT_CONTENTS_TOOLTIP"] =   "Сводная информация о предметов, распакованных из контейнеров, будет напечатана в чате после выполнения команды «Открыть все контейнеры».",
