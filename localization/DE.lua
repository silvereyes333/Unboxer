UNBOXER_STRINGS = {
    ...
    ["SI_UNBOXER_AUTOLOOT_DELAY"] =          "Verzögerung beim automatischen Auspacken (Sekunden)",
    ["SI_UNBOXER_AUTOLOOT_DELAY_TOOLTIP"] =  "Wartezeit in Sekunden, bevor ein Container automatisch ausgepackt wird.",
    ["SI_UNBOXER_VERBOSE"] =                 "Chatnachrichten für entpackte Gegenstände anzeigen",
    ["SI_UNBOXER_VERBOSE_TOOLTIP"] =         "",
    ...
    ["SI_UNBOXER_SUMMARY_TOOLTIP"] =         "Zeigt eine einzelne Chat-Zusammenfassung der entpackten Gegenständen aus der oben genannten Kategorie an, anstatt einzelne Nachrichten für jedes Gegenstande.",
